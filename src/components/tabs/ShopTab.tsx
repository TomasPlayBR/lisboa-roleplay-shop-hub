...
const vips: Vip[] = [
  ...
  },
  {
    ...
    benefits: ["Tudo do Recruta", "Vantagens económicas avançadas", "Acesso prioritário a eventos"],
  },
  {
    id: "elite",
    name: "Elite",
    ...
    benefits: ["Tudo do Veterano", "Recompensas premium semanais", "Skins exclusivas"],
  },
  {
    id: "apex",
    name: "APEX",
    ...
    benefits: ["Tudo do Elite", "Estatuto máximo do servidor", "Privilégios irrestritos"],
  },
];
